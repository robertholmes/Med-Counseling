...
@section('content')
    <div class="row">
        ...
        {{--<div class="col-md-10 col-md-offset-1">--}}
            ...
            {{--<div class="panel panel-default">--}}
                {{--<div class="panel-heading"><i class="fa fa-home"></i> Start A New Counseling Session</div>--}}
                {{--<div class="center-block btn-toolbar" style="max-width:800px">--}}
                    {{--<a href="#" class="btn btn-success btn-lg">--}}
                        {{--<span class="glyphicon glyphicon-plus"></span> Start A New Session--}}
                    {{--</a>--}}
        ...
        {{--<div class="col-md-10 col-md-offset-1">--}}
            ...
            {{--<div class="panel panel-default">--}}
                {{--<div class="panel-heading"><i class="fa fa-home"></i> Check Status of Existing Status </div>--}}
