                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($user->canChangePassword())
                                                <a href="redirect(" class="btn btn-warning btn-xs">{{ trans('navs.frontend.user.change_password') }}</a>
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>{{ trans('labels.general.actions') }}</th>
                                        <td>
                                            <a href="{!! route('frontend.accounts.create') !!}" class="btn btn-primary btn-xs">Start Application</a>


                                                <a href="{!! route('frontend.accounts.index') !!}" class="btn btn-warning btn-xs">Review Existing Applications</a>
